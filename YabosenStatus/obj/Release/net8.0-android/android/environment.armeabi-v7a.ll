...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 504365312, ; hash 0x1e100100, from name: libaot-YabosenStatus
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1012990181, ; hash 0x3c6100e5, from name: libaot-YabosenStatus.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 111
	...
	%struct.DSOCacheEntry {
		i64 1076655077, ; hash 0x402c73e5, from name: aot-YabosenStatus
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	...
	%struct.DSOCacheEntry {
		i64 1086508478, ; hash 0x40c2cdbe, from name: aot-YabosenStatus.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 124
	...
	%struct.DSOCacheEntry {
		i64 1307337556, ; hash 0x4dec6354, from name: YabosenStatus
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 143
	...
	%struct.DSOCacheEntry {
		i64 3752799984, ; hash 0xdfaf2ef0, from name: YabosenStatus.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 443
