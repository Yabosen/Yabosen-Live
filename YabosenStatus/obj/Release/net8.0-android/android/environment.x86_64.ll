...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670626, ; uint32_t jnienv_initialize_method_token (0x6001ca2)
	i32 100670625, ; uint32_t jnienv_registerjninatives_method_token (0x6001ca1)
...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 265767903393016841, ; hash 0x3b032800270ec09, from name: libaot-YabosenStatus.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
		i64 274660847975729299, ; hash 0x3cfca96054d0893, from name: System.Net.Http.Json.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.63_name, ; name: libaot-System.Net.Http.Json.dll.so
		ptr null; void* handle (0x0)
	}, ; 8
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8246680392695458313, ; hash 0x7272181fd6caaa09, from name: libaot-YabosenStatus
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 208
	...
	%struct.DSOCacheEntry {
		i64 12331969569057999939, ; hash 0xab23f4fc48a10c43, from name: aot-YabosenStatus
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 331
	...
	%struct.DSOCacheEntry {
		i64 12405057132389703679, ; hash 0xac279dbcb2839fff, from name: aot-YabosenStatus.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 333
	...
	%struct.DSOCacheEntry {
		i64 16101187810247284945, ; hash 0xdf72e90173a398d1, from name: YabosenStatus
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 440
	...
	%struct.DSOCacheEntry {
		i64 17759590781004654123, ; hash 0xf676bdb89215a62b, from name: YabosenStatus.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-YabosenStatus.dll.so
		ptr null; void* handle (0x0)
	}, ; 482
...
@.env.3 = private unnamed_addr constant [37 x i8] c"e796d901-541b-48a2-9838-2009b5ae95b4\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [19 x i8] c"com.yabosen.status\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-YabosenStatus.dll.so\00", align 16
...
@.DSOCacheEntry.63_name = private unnamed_addr constant [35 x i8] c"libaot-System.Net.Http.Json.dll.so\00", align 16
